...
<section class="bg-white py-8">
    ...
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
        <div class="mx-auto max-w-screen-sm text-center lg:mb-16 mb-8">
            ...
            <p class="font-light text-gray-500 sm:text-xl dark:text-gray-900">We bring you a wide selection of original and authentic beauty and cosmetics essentials at affordable prices, delivered to your doorstep.</p>
        </div>
        <div class="grid gap-8 lg:grid-cols-2">
            <article  class="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                ...
                <div class="flex justify-between items-center">
                    ...
                    <a href="{{ route('login') }}" class="inline-flex items-center font-medium text-primary-600 dark:text-primary-500 hover:underline">
                        View Products
