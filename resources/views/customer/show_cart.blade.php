...
<div class="center">
        ...
        <tr>
            ...
            <td>
                <a href="{{ url('/remove_cart', $cart->id) }}" onclick="return confirm('Are you sure to remove this product?')"
                   class="px-4 py-2 bg-red-500 text-white hover:bg-red-600 rounded-full focus:outline-none focus:ring-2 focus:ring-red-300">
                    Remove
                </a>
            </td>
    ...
    <div>
        ...
        <a href="{{url('cash_order')}}" class="px-4 py-2 bg-red-500 text-white hover:bg-red-600 rounded-full focus:outline-none focus:ring-2 focus:ring-red-300">Cash on Delivery</a>
        <a href="{{url('stripe',$totalprice)}}" class="px-4 py-2 bg-red-500 text-white hover:bg-red-600 rounded-full focus:outline-none focus:ring-2 focus:ring-red-300">Pay using Card</a>
    </div>
