...
<section class="bg-white py-8">
    ...
    <div class="container mx-auto flex items-center flex-wrap pt-4 pb-12">
        ...
        @foreach($product as $product)
            @if($product->category=="Women's Perfume")

        <div class="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
            <a href="{{ url('product_details',$product->id) }}">
                <img class="hover:grow hover:shadow-lg" src="product/{{$product->image}}">
            </a>
            ...
            <div class="pt-3 flex items-center justify-between">
                ...
                @if($product->discount_price!=null)
                    <p class="pt-1 text-gray-900" style="text-decoration: line-through">${{$product->price}}</p>
                    <p class="pt-1 text-gray-900">${{$product->discount_price}}</p>
                @else
