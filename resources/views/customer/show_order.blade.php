        ...
        @foreach($order as $order)
            ...
            <tr>
                ...
                <td>
                    ...
                    <a class="px-4 py-2 bg-red-500 text-white hover:bg-red-600 rounded-full focus:outline-none focus:ring-2 focus:ring-red-300" href="{{url('cancel_order',$order->id)}}" onclick="return confirm('Are you sure to cancel this order?')">
                        Cancel
                    </a>
                        @else
                        <p>Not allowed</p>
