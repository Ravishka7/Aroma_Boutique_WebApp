                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex flex-row justify-content-between">
                            <h4 class="card-title mb-1">Trending Products</h4>
                                ...
                                <div class="preview-list">
                                    <div class="preview-item border-bottom">
                                        ...
                                        <div class="preview-item-content d-sm-flex flex-grow">
                                            <div class="flex-grow">
                                                <h6 class="preview-subject">COCO NOIR CHANEL</h6>
                                                <p class="text-muted mb-0">Fast moving</p>
                                            </div>
                                    ...
                                    <div class="preview-item border-bottom">
                                        ...
                                        <div class="preview-item-content d-sm-flex flex-grow">
                                            <div class="flex-grow">
                                                <h6 class="preview-subject">Davidoff CoolWater</h6>
                                                <p class="text-muted mb-0">Fast Moving</p>
                                            </div>
                                            <div class="mr-auto text-sm-right pt-2 pt-sm-0">
                                    ...
                                    <div class="preview-item border-bottom">
                                        ...
                                        <div class="preview-item-content d-sm-flex flex-grow">
                                            <div class="flex-grow">
                                                <h6 class="preview-subject">Georgia Armani</h6>
                                                <p class="text-muted mb-0">Fast Moving</p>
                                            </div>
                                            <div class="mr-auto text-sm-right pt-2 pt-sm-0">
